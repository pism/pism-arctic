...
for gcm in CCSM4 CNRM-CM5 GISS-E2-R IPSL-CM5A-LR MIROC-ESM MPI-ESM-P MRI-CGCM3; do
    ...
    cdo $cdo_opt fldmean ${domain}_${gcm}_lgm.nc ${domain}_${gcm}_lgm_fldmean.nc
    cdo $cdo_opt chname,ts,air_temp,pr,precipitation -remapbil,../../grids/akglaciers_2km.txt ${gcm}_historical.nc  ${domain}_${gcm}_historical.nc
    cdo $cdo_opt fldmean ${domain}_${gcm}_historical.nc ${domain}_${gcm}_historical_fldmean.nc
