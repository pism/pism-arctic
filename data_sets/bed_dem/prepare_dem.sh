...
glodem=ak_glo_90_geoid.tif
glodem_slope=ak_glo_90_geoid_slope.tif
epsg=5936
v=2023_millan
...
for grid in 100 250 500 1000 2000 5000; do
    ...
    gdalwarp $options -dstnodata 0 -t_srs EPSG:${epsg} -te $x_min $y_min $x_max $y_max  -tr $grid $grid GEBCO_2022.nc pism_${domain}_v${v}_g${grid}m_gebco.nc
    ...
    cdo -f nc4 ifthenelse pism_${domain}_v${v}_g${grid}m_glo.nc pism_${domain}_v${v}_g${grid}m_glo.nc pism_${domain}_v${v}_g${grid}m_gebco.nc pism_${domain}_v${v}_g${grid}m.nc
    ...
    cdo -L -f nc4 ifthenelse -selvar,topg pism_${domain}_v${v}_g${grid}m_malaspina_bed.nc -selvar,topg pism_${domain}_v${v}_g${grid}m_malaspina_bed.nc -selvar,topg pism_${domain}_v${v}_g${grid}m.nc pism_${domain}_v${v}_g${grid}m_topg.nc
