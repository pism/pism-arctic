...
python initialization.py -e alaska.csv -s pleiades_broadwell -q long -w 80:00:00  --domain akglaciers -g ${grid} -n${n} --duration ${duration} --step ${duration} --o_dir ${odir} --exstep 100 -i 2020_04_cru/state/akglaciers_g2000m_id_CRU-DEF-1_0_10000_backup.nc
